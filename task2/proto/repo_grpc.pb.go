...
type RepositoryServiceClient interface {
	GetRepository(ctx context.Context, in *GetRepoRequest, opts ...grpc.CallOption) (*RepoResponse, error)
}
...
func (c *repositoryServiceClient) GetRepository(ctx context.Context, in *GetRepoRequest, opts ...grpc.CallOption) (*RepoResponse, error) {
...
type RepositoryServiceServer interface {
	GetRepository(context.Context, *GetRepoRequest) (*RepoResponse, error)
...
func (UnimplementedRepositoryServiceServer) GetRepository(context.Context, *GetRepoRequest) (*RepoResponse, error) {
...
func _RepositoryService_GetRepository_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RepositoryServiceServer).GetRepository(ctx, req.(*GetRepoRequest))
	}
