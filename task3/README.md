...
Продолжаем развивать наше приложение из второго задания. В рамках этой задачи предстоит реализовать "скелет" нашего будущего полноценного микросервисного приложения, а именно, разделить сервис Collector на Collector и Processor. Ну и не забыть про API Gateway
