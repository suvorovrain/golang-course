...
const (
	Processor_GetInfoRepo_FullMethodName = "/processor.proto.Processor/GetInfoRepo"
	Processor_Ping_FullMethodName        = "/processor.proto.Processor/Ping"
)
...
func (c *processorClient) GetInfoRepo(ctx context.Context, in *GetInfoRepoRequest, opts ...grpc.CallOption) (*GetInfoRepoResponce, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetInfoRepoResponce)
	err := c.cc.Invoke(ctx, Processor_GetInfoRepo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedProcessorServer) GetInfoRepo(context.Context, *GetInfoRepoRequest) (*GetInfoRepoResponce, error) {
...
func _Processor_GetInfoRepo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetInfoRepoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProcessorServer).GetInfoRepo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Processor_GetInfoRepo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProcessorServer).GetInfoRepo(ctx, req.(*GetInfoRepoRequest))
	}
...
var Processor_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "processor.proto.Processor",
